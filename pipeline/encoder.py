...
class SpectrumEncoder(nn.Sequential):
    def __init__(self,  in_channels: int,
                        out_channels: List[int] | int = [64, 96, 128],
        ...
        Args:
            in_channels (int): input channels for encoder
            out_channels (List[int] | int ): list of out channels for each blocks. Defaults to [64, 96, 128].
